...
class EditclientForm(forms.ModelForm):
    nom = forms.CharField(widget=forms.TextInput(), max_length=50, required=False)
    prenom = forms.CharField(widget=forms.TextInput(), max_length=50, required=False)
    telephone = forms.IntegerField(widget=forms.TextInput(), required=False)
    banquaire = forms.IntegerField(widget=forms.TextInput(), required=False)
    OM = forms.IntegerField(widget=forms.TextInput(), required=False)
    MOMO = forms.IntegerField(widget=forms.TextInput(), required=False)
    ...
    class Meta:
        model = Client
        fields = ('nom', 'prenom', 'telephone', 'banquaire', 'OM', 'MOMO', 'user_type')
